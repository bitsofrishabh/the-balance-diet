...
export function LeadGenerationForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const GOOGLE_SCRIPT_URL =
        'https://script.google.com/macros/s/AKfycby5yssX2FjTrKMuZtZVNg5AH_BiHfGnAXp4sMx2bKwzpfVFsmqg6F6u-yRgeC9yHwtrKQ/exec';
  ...
  if (isSubmitted) {
    return (
      <section className="h-full flex flex-col py-16 bg-gradient-to-br from-primary-50 to-secondary-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex-1 flex">
          <div className="bg-white rounded-3xl p-8 shadow-xl m-auto">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex-1 flex">
        <div className="flex flex-col h-full w-full">
          ...
          <div className="text-center mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">Free Health Assessment</h2>
            <p className="text-lg text-gray-600">
              Share your health information with us and get a personalized consultation to kickstart your wellness journey.
            </p>
          </div>
